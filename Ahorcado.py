"""
El Ahorcado es un juego para dos personas, usualmente jugado con lápiz y papel. 
Un jugador piensa en una palabra y dibuja un espacio en la página por cada 
letra de la palabra. 
Entonces el segundo jugador intenta adivinar letras de la palabra. Si adivina 
correctamente, el primer jugador escribe la letra en el espacio correspondiente. 
Si la letra no está en la palabra, el primer jugador dibuja una parte del cuerpo 
del ahorcado. Si el segundo jugador consigue adivinar todas las letras de la 
palabra antes de que el dibujo del ahorcado esté completo, gana. 
¡Pero si no consigue adivinar la palabra a tiempo el segundo jugador pierde!
"""
import random
...
def mostrarTablero(IMÁGENES_AHORCADO, letrasIncorrectas, letrasCorrectas, palabraSecreta):
      ...
      for i in range(len(palabraSecreta)): # completar los espacios vacíoslas letras adivinadas
